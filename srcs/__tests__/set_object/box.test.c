...
void		test_set_box_case1(void)
{
	...
	test(
		memcmp(box->axis_mat.arr[0], &normalized_a, sizeof(t_vec3)) == 0,
		"set_box : box->axis_mat.arr[0]"
	);

	test(
		memcmp(box->axis_mat.arr[1], &normalized_b, sizeof(t_vec3)) == 0,
		"set_box : box->axis_mat.arr[1]"
	);

	test(
		memcmp(box->axis_mat.arr[2], &c, sizeof(t_vec3)) == 0,
		"set_box : box->axis_mat.arr[2]"
	);
